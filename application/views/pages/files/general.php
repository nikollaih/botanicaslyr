    ...
    <table width="100%" class="table-products">
        ...
        <tbody>
            <?php
                ...
                if ($products != false) {
                    foreach ($products as $p) {
                        $total += ($p['precio_producto_pc'] * $p['cantidad_producto_pc']);
            ?>
                        <tr>
                            <td>
                            ...
                            <td class="text-center">
                                <?php echo $p['cantidad_producto_pc'] ?>
                            </td>
                            <td class="text-right">
                                $<?php echo number_format($p['precio_producto_pc'],0,',','.') ?>
                            </td>
                            <td class="text-right">
                                $<?php echo number_format($p['precio_producto_pc'] * $p['cantidad_producto_pc'],0,',','.') ?>
                            </td>
                        </tr>
            <?php
                    }
            ...
            <tr>
                ...
                <td class="text-right">
                    <strong>$<?php echo number_format($total + $ap['valor_consulta'],0,',','.') ?></strong>
                </td>
            </tr>
        </tbody>
    </table>
